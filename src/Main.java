 ...
 *
 * Все ресурсы текстовые.
 * Необходимо определить оптимальную производительность.
 ...
 * Максимальный размер массива слов 2000 элементов.
 *
 *
 * Предложение это последовательность слов,
 * начинающаяся с заглавной буквы и заканчивающаяся точкой,
